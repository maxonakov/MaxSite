...
$fields = [
    'header_top_menu_group_fields' => [
        'type'              => 'group-field',
        'section'           => 'header_top_menu_element_section',
        'priority'          => 5,
        'tabs'              => [
            'desktop'            => [
                ...
                'controls'      => [
                    'header_top_menu_sep',
                    'header_top_menu_assign',
                    'header_top_menu_sep_parent',
                    'header_top_menu_parent_item_spacing',
                    'header_top_menu_parent_item_padding',
                    'header_top_menu_sep_3',
                    'header_top_menu_container_padding',
                    'header_top_menu_container_margin'
                ]
            ],
            'tablet'            => [
                ...
                'controls'      => [
                    'header_top_menu_sep_3',
                    'header_top_menu_container_md_padding',
                    'header_top_menu_container_md_margin'
                ]
            ],
            'mobile'            => [
                ...
                'controls'      => [
                    'header_top_menu_sep_3',
                    'header_top_menu_container_sm_padding',
                    'header_top_menu_container_sm_margin'
                ]
            ]
        ],
    ],
    ...
    'header_top_menu_sep_parent' => [
        'type'              => 'custom',
        'section'           => 'header_top_menu_element_section',
        'default'           => '<h3 style="border-width:1px 0;border-style: solid;border-color: #fff;margin:0 -11px;padding: 8px 12px;background: #fff;">' . esc_html__( 'Menu Items', 'bizness' ) . '</h3>',
        'priority'          => 10
    ],
    'header_top_menu_parent_item_spacing' => [
        'type'              => 'slider',
        ...
        'output'            => [
            [
                ...
                'element'       => '#top-menu li:not(:last-child)',
                'suffix'        => 'px'
            ]
        ],
    ],
    ...
    'header_top_menu_container_padding' => [
        ...
        'output'            => [
            [
                ...
                'element'   => '.site-header nav#top-navigation',
            ],
            [
