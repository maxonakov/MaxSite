<?php
/**
 * Add Footer HTML element settings.
 *
 * @package Bizness
 */

$fields = [
    'footer_html_group_fields' => [
        'type'              => 'group-field',
        'section'           => 'footer_html_element_section',
        'priority'          => 5,
        'tabs'              => [
            'desktop'            => [
                ...
                'controls'      => [
                    ...
                    'footer_html_content',
                    'footer_html_sep_2',
                    'footer_html_container_padding',
                    'footer_html_container_margin'
                ]
            ],
            'tablet'            => [
                ...
                'controls'      => [
                    'footer_html_sep_2',
                    'footer_html_container_md_padding',
                    'footer_html_container_md_margin'
            ...
            'mobile'            => [
                ...
                'controls'      => [
                    'footer_html_sep_2',
                    'footer_html_container_sm_padding',
                    'footer_html_container_sm_margin'
                ]
            ]
        ],
    ],
    ...
    'footer_html_content' => [
        ...
        'js_vars'           => [
            [
                'element'   => '.site-footer .footer-html-inner',
                'function'  => 'html'
            ]
        ],
    ],
