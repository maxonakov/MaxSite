<?php
/**
 * Add footer social element settings.
 *
 * @package Bizness
 */

$fields = [
    'footer_social_network_group_fields' => [
        'type'              => 'group-field',
        'section'           => 'footer_social_element_section',
        'priority'          => 5,
        'tabs'              => [
            'desktop'            => [
                ...
                'active_tab'    => true,
                'controls'      => [
                    'footer_social_network_setting_inherit',
                    'footer_social_network_sep_3',
                    'footer_social_network_sep_two',
                    'footer_social_network_border_width',
                    'footer_social_network_border_radius',
                    'footer_social_network_padding',
                    'footer_social_network_sep_4',
                    'footer_social_network_container_padding',
                    'footer_social_network_container_margin'
                ]
            ],
            'tablet'            => [
                ...
                'controls'      => [
                    'footer_social_network_sep_3',
                    'footer_social_network_md_border_width',
                    'footer_social_network_md_border_radius',
                    'footer_social_network_md_padding',
                    'footer_social_network_sep_4',
                    'footer_social_network_container_md_padding',
                    'footer_social_network_container_md_margin'
                ]
            ],
            'mobile'            => [
                ...
                'controls'      => [
                    'footer_social_network_sep_3',
                    'footer_social_network_sm_border_width',
                    'footer_social_network_sm_border_radius',
                    'footer_social_network_sm_padding',
                    'footer_social_network_sep_4',
                    'footer_social_network_container_sm_padding',
                    'footer_social_network_container_sm_margin'
                ]
            ]
        ],
    ],
    ...
    'footer_social_network_border_width' => [
        ...
        'output'            => [
            [
                ...
                'element'       => '.site-footer .footer-social-inner li >*',
                'suffix'        => 'px'
            ]
        ],
    ],
    ...
    'footer_social_network_container_padding' => [
        ...
        'output'            => [
            [
                'choice'    => 'padding-top',
                'property'  => 'padding-top',
                'element'   => '.site-footer .footer-social-inner',
            ],
            [
                'choice'    => 'padding-bottom',
                'property'  => 'padding-bottom',
