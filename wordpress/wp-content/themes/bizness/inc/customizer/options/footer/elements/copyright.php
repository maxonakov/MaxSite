<?php
/**
 * Add Footer Copyright element settings.
 *
 * @package Bizness
 */

$fields = [
    'footer_copyright_group_fields' => [
        'type'              => 'group-field',
        ...
        'tabs'              => [
            'desktop'            => [
                ...
                'active_tab'    => true,
                'controls'      => [
                    'footer_copyright_sep_1',
                    'footer_copyright_content',
                    'footer_copyright_sep_2',
                    'footer_copyright_container_padding',
                    'footer_copyright_container_margin'
                ]
            ],
            'tablet'            => [
                ...
                'controls'      => [
                    'footer_copyright_sep_2',
                    'footer_copyright_container_md_padding',
                    'footer_copyright_container_md_margin'
            ...
            'mobile'            => [
                ...
                'controls'      => [
                    'footer_copyright_sep_2',
                    'footer_copyright_container_sm_padding',
                    'footer_copyright_container_sm_margin'
                ]
            ]
        ],
    ],
    ...
    'footer_copyright_content' => [
        'type'              => 'editor',
        'label'             => esc_html__( 'Copyright', 'bizness' ),
        'description'       => esc_html__( 'You can insert some arbitrary HTML code tags: {current_year}, {site_title} and {theme_author}', 'bizness' ),
        'section'           => 'footer_copyright_element_section',
        'default'           => __( 'Copyright &copy; {current_year} {site_title} - Powered by {theme_author}', 'bizness' ),
        'priority'          => 10,
        'partial_refresh'    => [
            'footer_copyright_content' => [
    ...
    'footer_copyright_container_padding' => [
        ...
        'output'            => [
            [
                ...
                'element'   => '.site-footer .footer-copyright-inner',
            ],
            [
