...
$fields = array(
	...
	'footer_bottom_left_elements'      => array(
		...
		'description'         => esc_html__( 'Click button to add new elements on lef column of bottom footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'             => 'footer_bottom_section',
		'row_label'           => array(
			'type'  => 'field',
		...
		'footer_bottom_label' => esc_html__( 'Add Element', 'bizness' ),
		'fields'              => array(
			'element_id' => array(
				'type'    => 'select',
	...
	'footer_bottom_center_elements'    => array(
		...
		'description'         => esc_html__( 'Click button to add new elements on center column of bottom footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'             => 'footer_bottom_section',
		'row_label'           => array(
			'type'  => 'field',
			'value' => esc_html__( 'Element', 'bizness' ),
	...
	'footer_bottom_right_elements'     => array(
		...
		'description'         => esc_html__( 'Click button to add new elements on right column of bottom footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'             => 'footer_bottom_section',
		'row_label'           => array(
			'type'  => 'field',
			'value' => esc_html__( 'Element', 'bizness' ),
