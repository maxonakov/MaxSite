...
$fields = array(
	'footer_top_row_group_fields'   => array(
		'type'     => 'group-field',
		...
		'tabs'     => array(
			'desktop' => array(
				...
				'active_tab' => true,
				'controls'   => array(
					'footer_top_left_elements',
					'footer_top_center_elements',
					'footer_top_right_elements',
					'footer_top_background',
					'footer_top_section_padding',
				),
			),
			'tablet'  => array(
			...
			'mobile'  => array(
				...
				'active_tab' => false,
				'controls'   => array(
					'footer_top_section_sm_padding',
				),
			),
		),
	),
	'footer_top_left_elements'      => array(
		'type'             => 'repeater',
		'label'            => esc_html__( 'Left Elements', 'bizness' ),
		'description'      => esc_html__( 'Click button to add new elements on lef column of top footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'          => 'footer_top_section',
		'row_label'        => array(
			'type'  => 'field',
		...
		'footer_top_label' => esc_html__( 'Add Element', 'bizness' ),
		'fields'           => array(
			'element_id' => array(
				'type'    => 'select',
	...
	'footer_top_center_elements'    => array(
		'type'             => 'repeater',
		'label'            => esc_html__( 'Center Elements', 'bizness' ),
		'description'      => esc_html__( 'Click button to add new elements on center column of top footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'          => 'footer_top_section',
		'row_label'        => array(
			'type'  => 'field',
			'value' => esc_html__( 'Element', 'bizness' ),
	...
	'footer_top_right_elements'     => array(
		'type'             => 'repeater',
		'label'            => esc_html__( 'Right Elements', 'bizness' ),
		'description'      => esc_html__( 'Click button to add new elements on right column of top footer section and re-arrange element orders by sorting them.', 'bizness' ),
		'section'          => 'footer_top_section',
		'row_label'        => array(
			'type'  => 'field',
			'value' => esc_html__( 'Element', 'bizness' ),
	...
	'footer_top_background'         => array(
		...
		'output'    => array(
			array(
				'element' => '.site-footer .site-footer-top-row',
			),
		),
	),
	'footer_top_section_padding'    => array(
		'type'        => 'dimensions',
	...
	'footer_top_section_md_padding' => array(
		'type'        => 'dimensions',
		'label'       => esc_html__( 'Padding', 'bizness' ),
		'description' => esc_html__( 'Set footer top section top and bottom padding.', 'bizness' ),
		'section'     => 'footer_top_section',
	...
	'footer_top_section_sm_padding' => array(
		'type'        => 'dimensions',
		'label'       => esc_html__( 'Padding', 'bizness' ),
		'description' => esc_html__( 'Set footer top section top and bottom padding.', 'bizness' ),
		'section'     => 'footer_top_section',
