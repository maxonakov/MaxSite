<?php
/**
 * Add Footer Widget 5 element settings.
 *
 * @package Bizness
 */

$fields = [
    'footer_widget_5_group_fields' => [
        'type'              => 'group-field',
        'section'           => 'footer_widget_5_element_section',
        'priority'          => 5,
        'tabs'              => [
            'desktop'            => [
                ...
                'active_tab'    => true,
                'controls'      => [
                    'footer_widget_5_sep_2',
                    'footer_widget_5_container_padding',
                    'footer_widget_5_container_margin'
                ]
            ],
            'tablet'            => [
                ...
                'controls'      => [
                    'footer_widget_5_sep_2',
                    'footer_widget_5_container_md_padding',
                    'footer_widget_5_container_md_margin'
            ...
            'mobile'            => [
                ...
                'controls'      => [
                    'footer_widget_5_sep_2',
                    'footer_widget_5_container_sm_padding',
                    'footer_widget_5_container_sm_margin'
                ]
            ]
        ],
    ],
    ...
    'footer_widget_5_container_padding' => [
        ...
        'output'            => [
            [
                ...
                'element'   => '.site-footer .footer-widget-5-wrap',
            ],
            [
